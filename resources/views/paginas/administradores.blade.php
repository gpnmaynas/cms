                 ...
                 {{--  @foreach ($administradores as $key => $value)
                    ...
                    <tr>
                      ...
                      if($value["foto"] == ""){
                        ...
                        echo '<td><img src="'.url('/').'/img/administradores/admin.svg" class="img-fluid rounded-circle"></td>';
              ...
              <div class="modal-body">
                  ...
                  <div class="form-group my-2 text-center">
                    ...
                    @if ($value["foto"] == "")
                     ...
                     <img src="{{url('/')}}/img/administradores/admin.svg" class="previsualizarImg_foto img-fluid py-2 w-25 rounded-circle">
